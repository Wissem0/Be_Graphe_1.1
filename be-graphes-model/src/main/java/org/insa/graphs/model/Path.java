...
public class Path {
    ...
    public double getTravelTime(double speed) {
        // TODO:
    	float len = (float) (getLength()*0.001) ; // Longueur du path en km
    	double temps = 0.0 ;
    	temps = ( len / speed )*3600 ; // temps en s
        return temps;
    }
